...
const API_URL = "http://localhost:5000/api/auth/register"; // 👉 cambio esto por la URL real de franco
...
const Apilogin = "http://localhost:5000/api/auth/login"; // 👉 cambio esto por la URL real de franco
